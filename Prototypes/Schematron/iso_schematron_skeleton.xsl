...
<xsl:template match="iso:schema[@queryBinding='exslt']" priority="10">
    <axsl:comment>This XSLT was automatically generated from a Schematron schema.</axsl:comment>
	<axsl:stylesheet
		...
		xmlns:math="http://exslt.org/math"
  		...
  		xmlns:regexp="http://exslt.org/regular-expressions"
   		...
   		extension-element-prefixes="date dyn exsl math randome regexp set str" >
