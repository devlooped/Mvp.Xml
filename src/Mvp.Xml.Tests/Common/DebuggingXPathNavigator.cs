...
public sealed class DebuggingXPathNavigator : XPathNavigator
{
    ...
    {
        var res = _navigator.IsSamePosition(other);
    ...
    {
        var res = _navigator.MoveToId(id);
    ...
    {
        var res = _navigator.MoveTo(other);
    ...
    {
        var res = _navigator.MoveToFirst();
    ...
    {
        var res = _navigator.MoveToFirstChild();
    ...
    {
        var res = _navigator.MoveToParent();
    ...
    {
        var res = _navigator.MoveToPrevious();
    ...
    {
        var attr = _navigator.GetAttribute(localName, namespaceURI);
    ...
    {
        var res = _navigator.MoveToAttribute(localName, namespaceURI);
    ...
    {
        var res = _navigator.MoveToFirstAttribute();
    ...
    {
        var res = _navigator.MoveToNextAttribute();
    ...
    {
        var attr = _navigator.GetNamespace(localName);
    ...
    {
        var res = _navigator.MoveToNamespace(@namespace);
    ...
    {
        var res = _navigator.MoveToFirstNamespace();
    ...
    {
        var res = _navigator.MoveToNextNamespace(namespaceScope);
