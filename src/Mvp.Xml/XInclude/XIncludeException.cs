...
public abstract class XIncludeException : Exception
{
    ...
    protected XIncludeException(string message) : base(message) { }
...
/// </remarks>
class ResourceException : XIncludeException
{
    /// <summary>
...
public class NonXmlCharacterException : FatalException
{
    ...
    public NonXmlCharacterException(char c)
        : base(string.Format(CultureInfo.CurrentCulture, Properties.Resources.NonXmlCharacter, ((int)c).ToString("X2")))
    {
    }
}
...
public class CircularInclusionException : FatalException
{
    ...
    public CircularInclusionException(Uri uri)
        : base(string.Format(CultureInfo.CurrentCulture, Properties.Resources.CircularInclusion, uri.AbsoluteUri)) { }
    ...
    public CircularInclusionException(Uri uri, string locationUri, int line, int position)
        : base(string.Format(CultureInfo.CurrentCulture, Properties.Resources.CircularInclusionLong, uri.AbsoluteUri, locationUri, line, position)) { }
}
...
public class FatalResourceException : FatalException
{
    ...
    public FatalResourceException(Exception re)
        : base(string.Format(CultureInfo.CurrentCulture, Properties.Resources.FatalResourceException, re.Message), re) { }
}
...
public class InvalidAcceptHTTPHeaderValueError : FatalException
{
    ...
    public InvalidAcceptHTTPHeaderValueError(char c)
        : base(string.Format(CultureInfo.CurrentCulture, Properties.Resources.InvalidCharForAccept, ((int)c).ToString("X2"))) { }
}
