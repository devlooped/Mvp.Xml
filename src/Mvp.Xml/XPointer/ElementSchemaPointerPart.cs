...
/// </summary>
class ElementSchemaPointerPart : PointerPart
{
    /// <summary>
    ...
    public override XPathNodeIterator Evaluate(XPathNavigator doc, XmlNamespaceManager nm) => XPathCache.Select(XPath, doc, nm);
