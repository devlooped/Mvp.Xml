...
public abstract class XPointerException : Exception
{
    ...
    public XPointerException(string message, Exception innerException) : base(message, innerException) { }
}
...
public class XPointerSyntaxException : XPointerException
{
    ...
    /// <param name="message">Error message</param>
    /// <param name="innerException">Inner exception</param>
    public XPointerSyntaxException(string message, Exception innerException) : base(message, innerException) { }
}
...
public class NoSubresourcesIdentifiedException : XPointerException
{
    ...
    /// <param name="message">Error message</param>
    /// <param name="innerException">Inner exception</param>
    public NoSubresourcesIdentifiedException(string message, Exception innerException) : base(message, innerException) { }
}
