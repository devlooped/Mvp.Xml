...
public class XmlFragmentReader : XmlWrappingReader
{
    ...
    public XmlFragmentReader(string rootElementName, XmlReader baseReader) : base(baseReader)
    {
    ...
    public XmlFragmentReader(string rootElementName, string rootXmlNamespace, XmlReader baseReader) : base(baseReader)
    {
        Guard.ArgumentNotNullOrEmptyString(rootElementName, "rootElementName");
    ...
    public XmlFragmentReader(XmlQualifiedName rootName, XmlReader baseReader) : base(baseReader)
    {
    ...
    void Initialize(XmlQualifiedName qualifiedRootName) => rootName = qualifiedRootName;
