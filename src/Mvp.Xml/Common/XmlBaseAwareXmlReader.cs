...
{
    XmlBaseState state = new();
    Stack<XmlBaseState> states;

    static XmlReaderSettings CreateReaderSettings()
    {
    ...
    static XmlReaderSettings CreateReaderSettings(XmlResolver resolver)
    {
    ...
    static XmlReaderSettings CreateReaderSettings(XmlNameTable nt)
    {
        var settings = CreateReaderSettings();
    ...
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri) : base(Create(uri, CreateReaderSettings()))
        => state.BaseUri = new Uri(base.BaseURI);

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given URI using the given resolver.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, XmlResolver resolver) : base(Create(uri, CreateReaderSettings(resolver)))
        => state.BaseUri = new Uri(base.BaseURI);
    ...
    /// name table.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, XmlNameTable nt) : base(Create(uri, CreateReaderSettings(nt)))
        => state.BaseUri = new Uri(base.BaseURI);

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given TextReader.
    /// </summary>        
    public XmlBaseAwareXmlReader(TextReader reader) : base(Create(reader, CreateReaderSettings())) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given uri and 
    /// TextReader.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, TextReader reader) : base(Create(reader, CreateReaderSettings(), uri))
        => state.BaseUri = new Uri(base.BaseURI);
    ...
    /// and name table.
    /// </summary>        
    public XmlBaseAwareXmlReader(TextReader reader, XmlNameTable nt) : base(Create(reader, CreateReaderSettings(nt))) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given uri, name table
    /// and TextReader.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, TextReader reader, XmlNameTable nt) : base(Create(reader, CreateReaderSettings(nt), uri))
        => state.BaseUri = new Uri(base.BaseURI);

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given stream.
    /// </summary>        
    public XmlBaseAwareXmlReader(Stream stream) : base(Create(stream, CreateReaderSettings())) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given uri and stream.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, Stream stream) : base(Create(stream, CreateReaderSettings(), uri))
        => state.BaseUri = new Uri(base.BaseURI);

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given uri and stream.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, Stream stream, XmlResolver resolver) : base(Create(stream, CreateReaderSettings(resolver), uri))
        => state.BaseUri = new Uri(base.BaseURI);
    ...
    /// and name table.
    /// </summary>        
    public XmlBaseAwareXmlReader(Stream stream, XmlNameTable nt) : base(Create(stream, CreateReaderSettings(nt))) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given stream,
    /// uri and name table.
    /// </summary>        
    public XmlBaseAwareXmlReader(string uri, Stream stream, XmlNameTable nt) : base(Create(stream, CreateReaderSettings(nt), uri))
        => state.BaseUri = new Uri(base.BaseURI);
    ...
    /// </summary>        
    public XmlBaseAwareXmlReader(TextReader reader, XmlReaderSettings settings) : base(Create(reader, settings)) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given <see cref="Stream"/> and <see cref="XmlReaderSettings"/>.        
    /// </summary>        
    public XmlBaseAwareXmlReader(Stream stream, XmlReaderSettings settings) : base(Create(stream, settings)) { }

    /// <summary>
    /// Creates XmlBaseAwareXmlReader instance for given <see cref="XmlReader"/> and <see cref="XmlReaderSettings"/>.        
    /// </summary>        
    public XmlBaseAwareXmlReader(XmlReader reader, XmlReaderSettings settings) : base(Create(reader, settings)) { }
    ...
    public override bool Read()
    {
        ...
        if (baseRead)
        {
            if (NodeType == XmlNodeType.Element && HasAttributes)
            {
                ...
                var newBaseUri = state.BaseUri == null ? new Uri(baseAttr) : new Uri(state.BaseUri, baseAttr);
