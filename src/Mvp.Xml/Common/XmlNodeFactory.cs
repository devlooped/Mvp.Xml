...
public class XmlNodeFactory
{
    ...
    abstract class SerializableNode : XmlElement
    {
    ...
    class XPathNavigatorNode : SerializableNode
    {
        readonly XPathNavigator navigator;

        public XPathNavigatorNode(XPathNavigator navigator) => this.navigator = navigator;

        public override void WriteTo(XmlWriter w) => w.WriteNode(navigator.ReadSubtree(), false);
    }

    class XmlReaderNode : SerializableNode
    {
        readonly XmlReader reader;
        readonly bool defaultAttrs;
    ...
    class ObjectNode : SerializableNode
    {
        readonly object serializableObject;

        public ObjectNode(object serializableObject) => this.serializableObject = serializableObject;

        public override void WriteTo(XmlWriter w)
        {
            var ser = new XmlSerializer(serializableObject.GetType());
