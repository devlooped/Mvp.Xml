...
public class SingletonXPathNodeIterator : XPathNodeIterator
{
    ...
    /// given node.
    /// </summary>
    public SingletonXPathNodeIterator(XPathNavigator nav) => navigator = nav;

    /// <summary>
    /// See <see cref="XPathNodeIterator.Clone()"/>
    /// </summary>
    public override XPathNodeIterator Clone() => new SingletonXPathNodeIterator(navigator.Clone());
