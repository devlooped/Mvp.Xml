...
/// </summary>
/// <remarks>Author: Daniel Cazzulino, <a href="https://cazzulino.com">blog</a>
...
public class SubtreeXPathNavigator : XPathNavigator
{
    ...
    public SubtreeXPathNavigator(XPathNavigator navigator) : this(navigator, false) { }
    ...
    SubtreeXPathNavigator(XPathNavigator root, XPathNavigator current, bool atRoot, bool enableFragment)
    {
    ...
    public override XPathNavigator Clone() => new SubtreeXPathNavigator(root, navigator, AtRoot, fragment);
    ...
    {
        if (other is not SubtreeXPathNavigator nav)
            return false;
    ...
    /// </summary>
    public override bool MoveToId(string id) => navigator.MoveToId(id);
    ...
    /// </summary>
    public override string GetAttribute(string localName, string namespaceUri) => AtRoot ? string.Empty : navigator.GetAttribute(localName, namespaceUri);

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToAttribute"/>.
    /// </summary>
    public override bool MoveToAttribute(string localName, string namespaceUri) => !AtRoot && navigator.MoveToAttribute(localName, namespaceUri);

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToFirstAttribute"/>.
    /// </summary>
    public override bool MoveToFirstAttribute() => !AtRoot && navigator.MoveToFirstAttribute();

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToNextAttribute"/>.
    /// </summary>
    public override bool MoveToNextAttribute() => !AtRoot && navigator.MoveToNextAttribute();

    /// <summary>
    /// See <see cref="XPathNavigator.GetNamespace"/>.
    /// </summary>
    public override string GetNamespace(string localName) => AtRoot ? string.Empty : navigator.GetNamespace(localName);

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToNamespace"/>.
    /// </summary>
    public override bool MoveToNamespace(string @namespace) => !AtRoot && navigator.MoveToNamespace(@namespace);

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToFirstNamespace(XPathNamespaceScope)"/>.
    /// </summary>
    public override bool MoveToFirstNamespace(XPathNamespaceScope namespaceScope) => !AtRoot && navigator.MoveToFirstNamespace(namespaceScope);

    /// <summary>
    /// See <see cref="XPathNavigator.MoveToNextNamespace(XPathNamespaceScope)"/>.
    /// </summary>
    public override bool MoveToNextNamespace(XPathNamespaceScope namespaceScope) => !AtRoot && navigator.MoveToNextNamespace(namespaceScope);
}
