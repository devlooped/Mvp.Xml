...
public class XPathIteratorReader : XmlTextReader, IXmlSerializable
{
    ...
    public override void Close() => current.Close();

    /// <summary>See <see cref="XmlReader.GetAttribute(string, string)"/></summary>
    public override string GetAttribute(string name, string ns) => current.GetAttribute(name, ns);

    /// <summary>See <see cref="XmlReader.GetAttribute(string)"/></summary>
    public override string GetAttribute(string name) => current.GetAttribute(name);

    /// <summary>See <see cref="XmlReader.GetAttribute(int)"/></summary>
    public override string GetAttribute(int i) => current.GetAttribute(i);

    /// <summary>See <see cref="XmlReader.LookupNamespace"/></summary>
    public override string LookupNamespace(string prefix) => current.LookupNamespace(prefix);

    /// <summary>See <see cref="XmlReader.MoveToAttribute(string, string)"/></summary>
    public override bool MoveToAttribute(string name, string ns) => current.MoveToAttribute(name, ns);

    /// <summary>See <see cref="XmlReader.MoveToAttribute(string)"/></summary>
    public override bool MoveToAttribute(string name) => current.MoveToAttribute(name);

    /// <summary>See <see cref="XmlReader.MoveToAttribute(int)"/></summary>
    public override void MoveToAttribute(int i) => current.MoveToAttribute(i);

    /// <summary>See <see cref="XmlReader.MoveToElement"/></summary>
    public override bool MoveToElement() => current.MoveToElement();

    /// <summary>See <see cref="XmlReader.MoveToFirstAttribute"/></summary>
    public override bool MoveToFirstAttribute() => current.MoveToFirstAttribute();

    /// <summary>See <see cref="XmlReader.MoveToNextAttribute"/></summary>
    public override bool MoveToNextAttribute() => current.MoveToNextAttribute();
    ...
    public override bool ReadAttributeValue() => current.ReadAttributeValue();

    /// <summary>See <see cref="XmlReader.ReadInnerXml"/></summary>
    public override string ReadInnerXml() => Read() ? Serialize() : string.Empty;
    ...
    /// </summary>
    public void WriteXml(XmlWriter writer) => writer.WriteNode(this, false);
    ...
    class FakedRootReader : XmlReader
    {
