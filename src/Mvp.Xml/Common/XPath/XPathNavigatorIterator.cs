...
{
    readonly List<XPathNavigator> navigators;
    int position = -1;
    ...
    /// </summary>
    public XPathNavigatorIterator(XPathNavigator navigator) : this()
    ...
    /// </summary>
    public XPathNavigatorIterator(XPathNodeIterator iterator) : this(iterator, false) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="XPathNavigatorIterator"/>
    /// using given list of navigators.
    /// </summary>
    public XPathNavigatorIterator(XPathNodeIterator iterator, bool removeDuplicates) : this()
    {
    ...
    public void Add(IEnumerable<XPathNavigator> navigatorsToAdd)
    {
        ...
        foreach (var navigator in navigatorsToAdd)
        {
            navigators.Add(navigator.Clone());
        }
    }
    ...
    /// </summary>
    public override XPathNodeIterator Clone() => new XPathNavigatorIterator(new List<XPathNavigator>(navigators));
