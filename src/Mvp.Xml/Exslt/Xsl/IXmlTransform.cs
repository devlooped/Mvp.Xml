...
public class OutputResolver : XmlUrlResolver
{
    ...
    public override Uri ResolveUri(Uri _, string relativeUri) => base.ResolveUri(baseUri, relativeUri);
}
...
/// </summary>
class DefaultXmlResolver : XmlUrlResolver { }