...
public class ExsltDatesAndTimes
{
    ...
    {
        public DateTime D;
        public TimeSpan Ts = new(TimeSpan.MinValue.Ticks);

        protected CultureInfo Ci = new("en-US");
        ...
        public ExsltDateTime(string inS)
        {
            ...
            else if (s.Length > 6)
            {
                ...
                if (zoneStr[3] == ':')
                {
                    try
                    {
                        var hours = int.Parse(zoneStr.Substring(0, 3));
                        var minutes = int.Parse(zoneStr.Substring(4, 2));
                        if (hours < 0)
                        {
                            minutes = -minutes;
                        }
        ...
        public bool HasTimeZone() => !(TimeSpan.MinValue.Ticks == Ts.Ticks);
        ...
        public override string ToString() => ToString(OutputFormat);
    ...
    internal class DateTimeTz : ExsltDateTime
    {
        ...
        protected override string[] ExpectedFormats => new[]
        {
        ...
        protected override string OutputFormat => "yyyy-MM-dd\"T\"HH:mm:ss";
    }
    ...
    internal class DateTz : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "yyyy-MM-dd";
    }
    ...
    internal class TimeTz : ExsltDateTime
    {
        ...
        protected override string[] ExpectedFormats => new string[]
        {
            "yyyy-MM-dd\"T\"HH:mm:sszzz",
            "yyyy-MM-dd\"T\"HH:mm:ssZ",
            "yyyy-MM-dd\"T\"HH:mm:ss",
        ...
        protected override string OutputFormat => "HH:mm:ss";
    }
    ...
    internal class YearMonth : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "yyyy-MM";
    }
    ...
    internal class YearTz : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "yyyy";
    }
    ...
    internal class Month : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "--MM--";
    }
    ...
    internal class Day : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "---dd";
    }
    ...
    internal class MonthDay : ExsltDateTime
    {
        ...
        protected override string OutputFormat => "--MM-dd";
    }

    readonly string[] dayAbbrevs = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
    readonly string[] dayNames = { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" };
    readonly string[] monthAbbrevs = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dateTime_RENAME_ME(string d) => DateTime(d);
    ...
    internal string DateTimeImpl(DateTimeTz dtz) => dtz.ToString();
    ...
    public string Date() => new DateTz().ToString();
    ...
    /// </summary>
    /// <returns>The current time</returns>        
    public string Time() => new TimeTz().ToString();
    ...
    public double Year() => System.DateTime.Now.Year;
    ...
    public bool LeapYear() => IsLeapYear((int)Year());

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public bool leapYear_RENAME_ME() => LeapYear();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public bool leapYear_RENAME_ME(string d) => LeapYear(d);
    ...
    public double MonthInYear() => System.DateTime.Now.Month;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double monthInYear_RENAME_ME() => MonthInYear();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double monthInYear_RENAME_ME(string d) => MonthInYear(d);
    ...
    double WeekInYear(DateTime d) => CultureInfo.InvariantCulture.Calendar.GetWeekOfYear(d, CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday);
    ...
    /// new weeks beginning on a Monday
    /// </returns>        
    public double WeekInYear() => WeekInYear(System.DateTime.Now);

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double weekInYear_RENAME_ME() => WeekInYear();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double weekInYear_RENAME_ME(string d) => WeekInYear(d);
    ...
    /// </remarks>        
    public double WeekInMonth() => WeekInMonth(System.DateTime.Now);

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double weekInMonth_RENAME_ME() => WeekInMonth();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double weekInMonth_RENAME_ME(string d) => WeekInMonth(d);
    ...
    public double DayInYear() => System.DateTime.Now.DayOfYear;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInYear_RENAME_ME() => DayInYear();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInYear_RENAME_ME(string d) => DayInYear(d);
    ...
    public double DayInWeek() => ((int)System.DateTime.Now.DayOfWeek) + 1;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInWeek_RENAME_ME() => DayInWeek();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInWeek_RENAME_ME(string d) => DayInWeek(d);
    ...
    /// </summary>
    /// <returns>The current day. </returns>        
    public double DayInMonth() => System.DateTime.Now.Day;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInMonth_RENAME_ME() => DayInMonth();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayInMonth_RENAME_ME(string d) => DayInMonth(d);
    ...
    /// <returns></returns>
    double DayOfWeekInMonth(int day) =>
    ...
    public double DayOfWeekInMonth() => DayOfWeekInMonth(System.DateTime.Now.Day);

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayOfWeekInMonth_RENAME_ME() => DayOfWeekInMonth();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double dayOfWeekInMonth_RENAME_ME(string d) => DayOfWeekInMonth(d);
    ...
    public double HourInDay() => System.DateTime.Now.Hour;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double hourInDay_RENAME_ME() => HourInDay();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double hourInDay_RENAME_ME(string d) => HourInDay(d);
    ...
    public double MinuteInHour() => System.DateTime.Now.Minute;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double minuteInHour_RENAME_ME() => MinuteInHour();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double minuteInHour_RENAME_ME(string d) => MinuteInHour(d);
    ...
    public double SecondInMinute() => System.DateTime.Now.Second;

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double secondInMinute_RENAME_ME() => SecondInMinute();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public double secondInMinute_RENAME_ME(string d) => SecondInMinute(d);
    ...
    /// </summary>
    /// <returns>The Engish name of the current day</returns>        
    public string DayName() => DayName((int)System.DateTime.Now.DayOfWeek);

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayName_RENAME_ME() => DayName();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayName_RENAME_ME(string d) => DayName(d);
    ...
    string DayAbbreviation(int dow)
    {
    ...
    /// </summary>
    /// <returns>The abbreviated English name of the current day</returns>        
    public string DayAbbreviation() => DayAbbreviation((int)System.DateTime.Now.DayOfWeek);

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayAbbreviation_RENAME_ME() => DayAbbreviation();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayAbbreviation_RENAME_ME(string d) => DayAbbreviation(d);
    ...
    /// </summary>
    /// <returns>The name of the current month</returns>        
    public string MonthName() => MonthName((int)MonthInYear());

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthName_RENAME_ME() => MonthName();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthName_RENAME_ME(string d) => MonthName(d);
    ...
    /// </summary>
    /// <returns>The abbreviated name of the current month</returns>        
    public string MonthAbbreviation() => MonthAbbreviation((int)MonthInYear());

    /// <summary>
    /// This wrapper method will be renamed during custom build 
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthAbbreviation_RENAME_ME() => MonthAbbreviation();
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthAbbreviation_RENAME_ME(string d) => MonthAbbreviation(d);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string formatDate_RENAME_ME(string d, string format) => FormatDate(d, format);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string parseDate_RENAME_ME(string d, string format) => ParseDate(d, format);
    ...
    public string Add(string datetime, string duration)
    {
        try
        {
            ...
            int negation = 1, years = 0, months = 0, days = 0, hours = 0, minutes = 0, seconds = 0;
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string addDuration_RENAME_ME(string duration1, string duration2) => AddDuration(duration1, duration2);
    ...
    double Seconds(ExsltDateTime d)
    {
    ...
    public double Seconds() => Seconds(new DateTimeTz());
    ...
    public string Duration() => Duration(Seconds());
    ...
    /// <returns></returns>        
    public string Duration(double seconds) => XmlConvert.ToString(TimeSpan.FromSeconds(seconds));
