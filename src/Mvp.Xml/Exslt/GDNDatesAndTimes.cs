...
public class GdnDatesAndTimes : ExsltDatesAndTimes
{
    ...
    /// </summary>
    public new string dayAbbreviation_RENAME_ME(string c) => DayAbbreviation(c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayAbbreviation_RENAME_ME(string d, string c) => DayAbbreviation(d, c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string dayName_RENAME_ME(string d, string c) => DayName(d, c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public new string dayName_RENAME_ME(string c) => DayName(c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public new string monthAbbreviation_RENAME_ME(string c) => MonthAbbreviation(c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthAbbreviation_RENAME_ME(string d, string c) => MonthAbbreviation(d, c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public string monthName_RENAME_ME(string d, string c) => MonthName(d, c);
    ...
    /// to provide conformant EXSLT function name.
    /// </summary>
    public new string monthName_RENAME_ME(string c) => MonthName(c);
}
