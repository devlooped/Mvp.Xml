...
*/
	...
	internal class PropertyInfo : MemberInfo
	{
		...
		{
			var method = new DynamicMethod( "xx", typeof( object ), new[] { typeof( object ) }, invokeMethod.IsPrivate );
			var generator = method.GetILGenerator();
			generator.Emit( OpCodes.Ldarg_0 );
			generator.Emit( OpCodes.Castclass, invokeMethod.DeclaringType );
			generator.Emit( OpCodes.Call, invokeMethod );
			if( invokeMethod.ReturnType.IsValueType )
				generator.Emit( OpCodes.Box, invokeMethod.ReturnType );
	...
	internal class FieldInfo : MemberInfo
	{
		...
		{
			var method = new DynamicMethod( "xx", typeof( object ), new[] { typeof( object ) }, field.IsPrivate );
			var generator = method.GetILGenerator();
			generator.Emit( OpCodes.Ldarg_0 );
