	...
	public class Node
	{
		...
		public void ResolveObject()
		{
			if( State == NodeState.ObjectNotKnown )
			{
				...
				try
				{
					this.Object = _memberInfo.GetValue( Parent.Object );
				}
				catch( Exception e )
				{
					AccessException = e;
		...
		private void CheckAndSwitchPolicy()
		{
			if( _nodePolicy != null )
			{
				INodePolicy newPolicy = _nodePolicy.GetNewPolicy( this );
				if( newPolicy != null )
				...
				{ 
					if( _nodePolicy != null ) 
					{
						...
						if( _name == null )
							...
							_name = _context.NameTable.Add( _name );
					}
					else
						return string.Empty;
				}
				...
				{ 
					if( _nodePolicy != null ) 
					{
						...
						if( _namespace == null )
							...
							_namespace = _context.NameTable.Add( _namespace );
					}
					else
						return string.Empty;
				}
		...
		public bool IsTransparent
		{
			get
			{
				...
				//System.Diagnostics.Trace.WriteLine( String.Format("Node {0}/{1} is transparent? {2}", this.Name, this.Object, _isTransparent) );
		...
		public Node GetAttribute( int index )
		{
			...
			Node res = AttributeFromCache( index );
			if( res == null )
			{
