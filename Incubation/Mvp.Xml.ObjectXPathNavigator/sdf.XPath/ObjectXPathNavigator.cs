...
namespace Mvp.Xml.ObjectXPathNavigator
{
	...
	public class ObjectXPathNavigator : XPathNavigator
	{
		...
		public object SelectObject(string xpath)
		{
			...
			if (i.MoveNext())
			{
				return ((ObjectXPathNavigator)i.Current).Object;
			}
			return null;
		}
		...
		public override string BaseURI
		{
			get
			{
				...
				if (_childNav != null)
					return _context.NameTable.Add(_childNav.BaseURI);

				return _node.Namespace;
			}
		}
		...
		public override string GetAttribute(string localName, string namespaceURI)
		{
			...
			XPathNavigator clone = Clone();
			if (clone.MoveToAttribute(localName, namespaceURI))
				return clone.Value;
		...
		public override string GetNamespace(string name)
		{
			...
			string ns = _context.NamespaceManager.LookupNamespace(name);
			if (ns != null)
				return ns;
			else
				return string.Empty;
		...
		public override bool HasAttributes
		{
			get
			{
				...
				return this.Clone().MoveToFirstAttribute();
			}
		}
		...
		public override bool HasChildren
		{
			get
			{
				...
				// Check that not all of them are transparent
				return this.Clone().MoveToFirstChild();
			}
		}
		...
		public override bool IsEmptyElement
		{
			get
			{
				...
				// Invoke child navigator
				if (_childNav != null)
					return _childNav.IsEmptyElement;

				return _node.ChildrenCount == 0;
			}
		}
		...
		public override string LocalName
		{
			get
			{
				...
				// Invoke child navigator
				if (_childNav != null)
					return _context.NameTable.Add(_childNav.LocalName);
		...
		public override string NamespaceURI
		{
			get
			{
				...
				// Invoke child navigator
				if (_childNav != null)
					return _context.NameTable.Add(_childNav.NamespaceURI);
		...
		public override bool MoveToFirstNamespace(XPathNamespaceScope namespaceScope)
		{
			...
			if( _childNav != null ) 
			{
				bool res = _childNav.MoveToFirstNamespace( namespaceScope );
				if( res )
					_childNavDepth++;
				return res;
			}
*/
		...
		public override bool MoveToNamespace(string name)
		{
			...
			if( _childNav != null ) 
			{
				bool res = _childNav.MoveToNamespace( name );
				if( res )
					_childNavDepth++;
				return res;
			}
*/
		...
		public override bool MoveToNext()
		{
			...
			Node newnode = GetNonTransparentSibling(_node, true);
			while (newnode != null)
			{
				if (!newnode.IsTransparent)
				{
		...
		public override bool MoveToNextNamespace(XPathNamespaceScope namespaceScope)
		{
			...
			// Invoke child navigator
			if (_childNav != null)
				return _childNav.MoveToNextNamespace(namespaceScope);
		...
		public object Object
		{
			get
			{
				...
				{
					IHasXmlNode ihxn = _childNav as IHasXmlNode;
					if (ihxn != null)
						return ihxn.GetNode();
					else
						return null;
		...
		private void Trace(string method)
		{
			...
			{
			string name;
			string ns = _node.Namespace;
				if (ns == string.Empty)
				name = _node.Name;
			else
			{
					string prefix = _context.NamespaceManager.LookupPrefix(ns);
					if (prefix == null)
					name = _node.Name;
				else
						name = string.Format("{0}:{1}", prefix, _node.Name);
		}
				System.Diagnostics.Trace.WriteLine(
					string.Format("N#{0}\t{1}\t{2}\t[{3}]\t#{4}",
								this.GetHashCode(), method, name, _node.NodeType, _node.GetHashCode()));
			}
			else
			{
				System.Diagnostics.Trace.WriteLine(
