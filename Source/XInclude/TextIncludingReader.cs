					...
					if (_value == null)
					{
						...
						*/
						...
						catch (OutOfMemoryException oome)
						{
							...
							throw new ResourceException(String.Format(CultureInfo.CurrentCulture, Properties.Resources.OutOfMemoryWhileFetchingResource, _href), oome);
						}
						catch (IOException ioe)
						{
							throw new ResourceException(String.Format(CultureInfo.CurrentCulture, Properties.Resources.IOErrorWhileFetchingResource, _href), ioe);
						}
					}
