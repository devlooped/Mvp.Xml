...
namespace Mvp.Xml.Common.XPath
{
	...
	public class XPathIteratorReader : XmlTextReader, IXmlSerializable
	{
		...
		public XPathIteratorReader(XPathNodeIterator iterator) : this(iterator, "root", String.Empty)
		{
		}
		...
		public XPathIteratorReader(XPathNodeIterator iterator, string rootName) : this(iterator, rootName, String.Empty)
		{
		}
		...
		public XPathIteratorReader(XPathNodeIterator iterator, string rootName, string ns) : base(new StringReader(String.Empty))
		{
